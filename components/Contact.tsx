...
const Contact: React.FC = () => {
  ...
  const handleWhatsAppSubmit = (e: React.FormEvent) => {
    ...
    const text = `*NOVA SOLICITAÇÃO - DEVVISION*%0A%0A` +
    ...
    <section id="contato" className="py-24 bg-slate-900/30">
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto glass rounded-[3rem] overflow-hidden border border-white/5 flex flex-col lg:flex-row shadow-2xl">
          {/* Info Side */}
          <div className="lg:w-2/5 bg-gradient-to-br from-blue-600 to-indigo-700 p-12 text-white relative overflow-hidden">
            <div className="absolute -top-24 -right-24 w-64 h-64 bg-white/10 rounded-full blur-3xl"></div>
            
            <h3 className="text-4xl font-extrabold mb-8 relative z-10">Solicite seu Orçamento</h3>
            ...
            <div className="space-y-8 relative z-10">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p className="text-xs text-white/50 uppercase tracking-widest">Atendimento Direto</p>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p className="text-xs text-white/50 uppercase tracking-widest">Disponibilidade</p>
            ...
            <div className="mt-20 pt-10 border-t border-white/10">
              ...
              <div className="flex gap-4">
                <div className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center"><i className="fab fa-github"></i></div>
                <div className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center"><i className="fab fa-linkedin"></i></div>
              </div>
            </div>
          </div>
            ...
            <form className="space-y-6" onSubmit={handleWhatsAppSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-900 border border-white/10 rounded-2xl px-5 py-4 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 transition-all text-white placeholder:text-slate-600" 
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select 
                    ...
                    value={formData.type}
                    onChange={handleChange}
                    className="w-full bg-slate-900 border border-white/10 rounded-2xl px-5 py-4 focus:outline-none focus:border-blue-500 transition-all appearance-none text-white cursor-pointer"
                  >
                    {websiteModels.map(m => (
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  onChange={handleChange}
                  rows={4} 
                  className="w-full bg-slate-900 border border-white/10 rounded-2xl px-5 py-4 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 transition-all text-white placeholder:text-slate-600 resize-none" 
              ...
              <button 
                type="submit"
                className="w-full bg-white text-slate-950 hover:bg-blue-500 hover:text-white py-5 rounded-2xl font-black text-lg shadow-xl transition-all transform active:scale-[0.98] flex items-center justify-center gap-3"
              >
                <i className="fab fa-whatsapp text-2xl"></i>
